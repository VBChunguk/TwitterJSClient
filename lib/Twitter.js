    ...
    this.oauth.getOAuthAccessToken(oauth.token, oauth.token_secret, oauth.verifier,
        function (error, oauth_access_token, oauth_access_token_secret, results) {
            if (error) {
                ...
                console.log('oauth.token: ' + oauth.token);
                console.log('oauth.token_secret: ' + oauth.token_secret);
                console.log('oauth.access_token: ' + access_token.access_token);
...
Twitter.prototype.postCustomApiCall = function (url, params, error, success, contentType) {
    var path =  url;
    var url = this.baseUrl + path;
    this.doPost(url, params, error, success, contentType);
};
